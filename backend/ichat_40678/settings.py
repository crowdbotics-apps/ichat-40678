"""
Django settings for ichat_40678 project.
...
WSGI_APPLICATION = 'ichat_40678.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ichat_40678 API",
    "DESCRIPTION": "API documentation for ichat_40678 App",
    "VERSION": "v1",
}
